...
<div class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="row">
      <div class="col-md-9 col-md-push-4"><p><%=processo.getUbicazione().getLocAmm().getRegione() %></p> </div>
      <div class="col-md-3 col-md-pull-9"><strong>${locale.getWord("stato")}</strong> </div>
    </div>
    <div class="row">
  ...
  <div class="row">
    ...
    <div class="row">
      ...
      <div class="row">
      <div class="col-md-6 col-md-push-4"><p></p> </div>
      <div class="col-md-5 col-md-pull-6"><strong>${locale.getWord("superificieAccumulo")}</strong> </div>
    </div>
  </div>
