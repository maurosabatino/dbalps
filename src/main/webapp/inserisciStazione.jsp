                    ...
                    <form action="Servlet" id="insertStazione"  method="POST" role="form">
                        <div class="panel panel-default"> <div class="panel-body"> <h4> ${locale.getWord("titoloStazione")} </h4>
                                ...
                                <div class="form-group" >
                                    ...
                                    <br>
                                    <div class="row">
                                        <div class="col-xs-6 col-md-6"><label for="aggregazionegiornaliera">${locale.getWord("aggregazioneTemporale")}<input type="text" name="aggregazioneGiornaliera"  id="aggregazionegiornaliera" class="form-control" placeholder="${locale.getWord("aggregazioneTemporale")}"></div>	
                                                <div class="col-xs-6 col-md-6"><label for="tipoaggregazione">${locale.getWord("tipoDiAggregazioneGiornaliera")}<input type="text" name="tipoaggregazione"  id="tipoaggregazione" class="form-control" placeholder="${locale.getWord("tipoDiAggregazioneGiornaliera")}"></div>
                                                        </div>
                                                        <br>
                                                        <div class="row">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-xs-6 col-md-4">
                                                                                        ...
                                                                                        <input type="text" id="latitudine" name="latitudine" class="form-control" placeholder=" ${locale.getWord("latitudine")}" 
                                                                                               ...
                                                                                               data-bv-notempty-message="The latitude is required"/>
                                                                                    </div>
                                                                                    <div class="col-xs-6 col-md-4">
                                                                                        ...
                                                                                        <input type="text" id="longitudine" name="longitudine" class="form-control" placeholder=" ${locale.getWord("longitudine")}" 
                                                                                               data-bv-notempty="true"
                                                                                               data-bv-notempty-message="The longitude is required"/>
                                                                                    </div>
                                                                                    <div class="col-xs-6 col-md-4">
