...
<%@page import="it.cnr.to.geoclimalp.dbalps.entity.processo.attributiProcesso.*"%>
                                ...
                                <div class="panel panel-default"> <div class="panel-body"> <h4> ${locale.getWord("litologiaTitolo")} </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <select id="${locale.getWord("lito")}" name="${locale.getWord("lito")}" class="form-control" placeholder="${locale.getWord("litologia")}"> </select>
                                            ...
                                            <div class="col-xs-6 col-md-6">
                                                ...
                                                <select id="${locale.getWord("proprietaTermiche")}" name="${locale.getWord("proprietaTermiche")}" class="form-control" placeholder="${locale.getWord("propTermiche")}"></select>
